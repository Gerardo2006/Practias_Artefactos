...
const int UMBRAL_TOUCH1 = 600;
const int UMBRAL_TOUCH2 = 300;
...
void loop() {
  ...
  if (valorTouch1 < UMBRAL_TOUCH1) {

    display.setCursor(15, 28);
    display.println("Al tocar el 1");

    display.fillCircle(105, 52, 5, SH110X_WHITE);
  } else if (valorTouch2 < UMBRAL_TOUCH2) {
    display.setCursor(15, 28);
    display.println("Al tocar el 2");

    display.fillCircle(105, 52, 5, SH110X_WHITE);
  } else {

    display.setCursor(32, 28);
    display.println("Sin tocar ninguno");
